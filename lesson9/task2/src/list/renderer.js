...
const compareTasks = (first, second) => first.done - second.done;
...
export const renderTasks = (tasksList) => {
  ...
  // getTasksList()
  //   .then((tasksList) => tasksList.sort(compareTasks).map(createListItem))
  //   .then((newList) => listElem.append(...newList));
